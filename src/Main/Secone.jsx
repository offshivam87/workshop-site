...
const Secone = () => {
  return (
    <div >
    <div className='w-full md:h-[130vh] h-[58vh]  overflow-x-hidden  overflow-y-hidden  relative flex justify-center '>
        <img src={bgimg} alt="" className='w-full   h-full object-cover' />
        <div className="achal  w-[85vw] md:w-[48vw]  h-[40vh] md:h-[88vh] md:top-[10%]  absolute top-[20%]">
            <img src={achal} alt=""  className='w-full h-full object-cover'/>
        </div>

        <div className="achal  w-[125vw] h-[13vh] md:w-[108vw] md:h-[35vh] md:top-[63%]   absolute top-[80%]">
            <img src={semicicular} alt=""  className='w-full h-full object-fill'/>
          
        </div>
         
                <h2 className='text-2xl text-white md:text-5xl   mx-auto font-poppins-bold text-center md:top-[79%] absolute top-[88%]'>Dr. Achal Gupta</h2>
