    ...
    return (
        <div>
            <div className="img w-full h-[85vh] md:h-[99rem] relative">
                ...
                <h2 className="absolute top-[5%] md:text-5xl md:top-[3%] w-full text-center text-[1.3rem] font-poppins-bold text-white">
                    Hear from happy patients
                </h2>
                <h2 className="absolute top-[10%] md:text-2xl md:top-[6.5%] w-full text-center text-[0.7rem] font-poppins text-white">
                    Real stories from our patients
                </h2>

                <div className="boxes absolute flex flex-wrap  gap-3 md:gap-8 top-[15%] md:top-[10%] left-[3%] md:left-[10%]">
                    <div className="bluebox w-[45vw] h-[40vh] md:w-[38vw] md:h-[120vh] rounded overflow-hidden">
                        <iframe
                     ...
                     <div className="bluebox w-[45vw] h-[40vh] md:w-[38vw] md:h-[120vh] rounded overflow-hidden">
                        <iframe
                           src="https://www.youtube.com/embed/LxInlyul5Gs"
                    ...
                    <h2 className='text-2xl font-poppins-bold text-white md:text-6xl md:left-[37%] md:top-[71%]  text-center absolute top-[70%] left-[31%]'>Contact us</h2>
            <h2 className='text-[0.7rem] md:text-3xl font-poppins text-white md:left-[22%] md:top-[75%]  text-center absolute top-[75%] left-[9%]'>Neuron Brain & Spine Centre, Gomti Nagar, Lucknow</h2>
